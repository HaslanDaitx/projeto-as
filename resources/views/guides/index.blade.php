    ...
    <div class="p-4 max-w-sm">
        <div class="flex rounded-lg h-full dark:bg-gray-800 bg-teal-900 p-8 flex-col">
            <div class="flex flex-col items-center pb-10">
                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{$guide->name}}</h5>
                <p class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ $guide->expertise}}</p>
                <p class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ $guide->email}}</p>
                <div class="flex mt-4 md:mt-6">
                    <a href="{{ url('guides/'.$guide->id.'/edit') }}"
