...
<div class="container">
    <form class="max-w-sm mx-auto" action="{{ url(path: 'explorers/' . $explorer->id) }}" method="POST"
        ...
        <div class="mb-5 mx-auto">
            <label for="name" class="block mb-2 text-sm font-medium text-white" style="margin-top: 150px;">Nome do
                Explorador:</label>
            <input type="text" name="name" id="name" value="{{ $explorer->name }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
        </div>
        <div class="mb-5 mx-auto">
            <label for="identification" class="block mb-2 text-sm font-medium text-white" style="margin-top: 150px;">Identificação do
                Explorador:</label>
            <input type="text" name="identification" id="identification" value="{{ $explorer->identification }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
        </div>
        <div class="mb-5 mx-auto">
            <label for="email" class="block mb-2 text-sm font-medium text-white" style="margin-top: 150px;">Email do
                Explorador:</label>
            <input type="text" name="email" id="email" value="{{ $explorer->email }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
        </div>
        <button type="submit"
