...
<div class="container mt-0">
    <form class="mx-auto bg-white mt-2 px-5" action="{{ url('expeditions') }}" method="POST" enctype="multipart/form-data"
        style="border-radius:10px; width:800px; margin-left:350px;">
        @csrf
        <div class="mb-5 mx-auto">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900"
                style="margin-top: 80px; padding-top:10px;">Nome da Expedição:</label>
        ...
        <div class="mb-5 mx-auto">
            <label for="duration" class="block mb-2 text-sm font-medium text-gray-900"
                style="margin-top: 80px; padding-top:10px;">Tempo da Expedição:</label>
